...
DATASET_PATH = PROJECT_ROOT / 'NEW_PATH_NAME'   # Will add once new dataset is added
...
if __name__ == '__main__':
    ...
    model = bmodel(num_classes=len(mangrove_type), freeze_base=True).to(gpu) # Updated this line to set the number of classes to the number of folders in the dataset
    # This should make it more flexible to changes in the dataset without needing to edit the code as much
